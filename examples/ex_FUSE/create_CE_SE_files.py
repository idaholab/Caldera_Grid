...
home_df_with_fixed_CEs = home_df.sample(n=1000)
home_df_with_fixed_CEs["Ext_strategy"] = "ext0001"

home_df_with_fixed_CEs.to_csv("inputs/home/CE_home_1000.csv", index = False)

work_df = df[(df["charge_event_id"] >= 200000000)  & (df["charge_event_id"] < 300000000)]
work_df_with_fixed_CEs = work_df.sample(n=1000)
work_df_with_fixed_CEs["Ext_strategy"] = "ext0001"

work_df_with_fixed_CEs.to_csv("inputs/work/CE_work_1000.csv", index = False)
...
SE_df_home.to_csv("inputs/home/SE_home_1000.csv", index = False)
SE_df_work.to_csv("inputs/work/SE_work_1000.csv", index = False)